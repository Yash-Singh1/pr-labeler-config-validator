...
function action(...[httpClient, core, readFileSync, process, validate]) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const labels = yield httpClient.getJson(`${process.env.GITHUB_API_URL}/repos/${process.env.GITHUB_REPOSITORY}/labels`, process.env.GITHUB_TOKEN
        ...
        const config = js_yaml_1.default.load(readFileSync(configFile, 'utf-8'));
        console.log('done');
...
const validate_1 = __importDefault(__nccwpck_require__(953));
(0, action_1.default)(new http_client_1.HttpClient(), core, fs_1.readFileSync, process_1.default, validate_1.default);
